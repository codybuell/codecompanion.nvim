...
## [17.5.0](https://github.com/codybuell/codecompanion.nvim/compare/v17.13.0...v17.5.0) (2025-08-08)


### ⚠ BREAKING CHANGES

* remove support for nvim-0.10 ([#1639](https://github.com/codybuell/codecompanion.nvim/issues/1639))
* **chat:** move the `goto_file_action` to `strategies.chat.opts`
* **chat:** move `opts.goto_file_action` to `strategies.chat.opts` ([#1571](https://github.com/codybuell/codecompanion.nvim/issues/1571))
* **chat:** reuse existing tabs when jumping to a file. ([#1569](https://github.com/codybuell/codecompanion.nvim/issues/1569))
* **tools:** move to function calling ([#1141](https://github.com/codybuell/codecompanion.nvim/issues/1141))
* **workspaces:** new workspace file format ([#1089](https://github.com/codybuell/codecompanion.nvim/issues/1089))

### Features

* **action_palette:** add `fzf_lua` provider ([#1443](https://github.com/codybuell/codecompanion.nvim/issues/1443)) ([03caa41](https://github.com/codybuell/codecompanion.nvim/commit/03caa41555d6615006d0ac8f6fcfee317cb967f0))
* **action_palette:** Add snacks.nvim as provider ([#1380](https://github.com/codybuell/codecompanion.nvim/issues/1380)) ([5b4a004](https://github.com/codybuell/codecompanion.nvim/commit/5b4a004ea082a0608aa98bb9041f79e56676cfeb))
* **action_palette:** preview open chats in telescope ([#1269](https://github.com/codybuell/codecompanion.nvim/issues/1269)) ([98a8d56](https://github.com/codybuell/codecompanion.nvim/commit/98a8d56e8cfc8e18396f03d6ebb2a44488eb477c))
* **adapters:** :boom: add tool support to Ollama ([#1585](https://github.com/codybuell/codecompanion.nvim/issues/1585)) ([e325370](https://github.com/codybuell/codecompanion.nvim/commit/e325370b8325697cb2f6becd13f267e6a12a0393))
* **adapters:** add caching to adapters that make http calls to model endpoints ([#1145](https://github.com/codybuell/codecompanion.nvim/issues/1145)) ([9e779b2](https://github.com/codybuell/codecompanion.nvim/commit/9e779b2a4abfc154ba09f3a2d25bc684a413cefd))
* **adapters:** add function calling to Novita ([#1888](https://github.com/codybuell/codecompanion.nvim/issues/1888)) ([c6fcb28](https://github.com/codybuell/codecompanion.nvim/commit/c6fcb28a69f0ceb5ee43922a8aadc7c663942246))
* **adapters:** add gemini 2.5 pro option ([#1180](https://github.com/codybuell/codecompanion.nvim/issues/1180)) ([f134b6c](https://github.com/codybuell/codecompanion.nvim/commit/f134b6c8f35ea1df4fa45d4f50319554178308fb))
* **adapters:** add gemini-2.5-flash and set as new default ([#1686](https://github.com/codybuell/codecompanion.nvim/issues/1686)) ([fb98d6c](https://github.com/codybuell/codecompanion.nvim/commit/fb98d6c03f6039939e676f1257c76d8480a3da4f))
* **adapters:** add gemini-2.5-pro-preview-06-05 ([#1605](https://github.com/codybuell/codecompanion.nvim/issues/1605)) ([fa8af3b](https://github.com/codybuell/codecompanion.nvim/commit/fa8af3bbaa70773a5d104ad8fdc567d30be260b4))
* **adapters:** add Mistral adapter ([#1118](https://github.com/codybuell/codecompanion.nvim/issues/1118)) ([e4754bb](https://github.com/codybuell/codecompanion.nvim/commit/e4754bb2501685721daa50ed843fb98af9d01725))
* **adapters:** add new Anthropic models ([#1488](https://github.com/codybuell/codecompanion.nvim/issues/1488)) ([70d52e0](https://github.com/codybuell/codecompanion.nvim/commit/70d52e00c23a6df9ccf3bc927e2658b320764302))
* **adapters:** add support for novita ([#1136](https://github.com/codybuell/codecompanion.nvim/issues/1136)) ([d55dc41](https://github.com/codybuell/codecompanion.nvim/commit/d55dc41e380fffcf3f799d8ed7257ff7a6d51521))
* **adapters:** add tool support to Azure OpenAI ([#1737](https://github.com/codybuell/codecompanion.nvim/issues/1737)) ([2c7e9b1](https://github.com/codybuell/codecompanion.nvim/commit/2c7e9b1aa9fa1f5a2b4d82f3f4e065cb0c8bc2b7))
* **adapters:** add tool support to HuggingFace ([#1907](https://github.com/codybuell/codecompanion.nvim/issues/1907)) ([afa34eb](https://github.com/codybuell/codecompanion.nvim/commit/afa34ebe3c48d74dc7e1c8b26d74f7f3a02cb531))
* **adapters:** add vision support ([#1455](https://github.com/codybuell/codecompanion.nvim/issues/1455)) ([1a4f0a4](https://github.com/codybuell/codecompanion.nvim/commit/1a4f0a44b1e52d1c569ce2f66b03b6804e74b183))
* **adapters:** can automatically choose default model when switching adapters ([#1369](https://github.com/codybuell/codecompanion.nvim/issues/1369)) ([90e82ab](https://github.com/codybuell/codecompanion.nvim/commit/90e82abf4d65b64b0986a5be0981ba13e84eee8b))
* **adapters:** can use adapter.opts.request to override Client:request ([#1469](https://github.com/codybuell/codecompanion.nvim/issues/1469)) ([ec73b64](https://github.com/codybuell/codecompanion.nvim/commit/ec73b64df3d0767eb0a5b42d942f9e02970ee95c))
* **adapters:** move ollama adapter to OpenAI endpoint ([79b2697](https://github.com/codybuell/codecompanion.nvim/commit/79b26971e4215e07d225c0d180248753de0036ff))
* **adapters:** new copilot default is gpt-4.1 ([#1540](https://github.com/codybuell/codecompanion.nvim/issues/1540)) ([15b0614](https://github.com/codybuell/codecompanion.nvim/commit/15b06141cb9d66ebb3b3038fbe4fa9cd0ee0fc15))
* **adapters:** Ollama adapter has support for `think` and more hyperparameters ([#1829](https://github.com/codybuell/codecompanion.nvim/issues/1829)) ([408b402](https://github.com/codybuell/codecompanion.nvim/commit/408b402da023ae41f13b4a071e4c79d3b0b78693))
* **adapters:** set Copilot default model to `gpt-4.1` ([bd14edb](https://github.com/codybuell/codecompanion.nvim/commit/bd14edb82ea07423c5c0f7484ef885a895374719))
* **adapters:** support Copilot enterprise ([#1533](https://github.com/codybuell/codecompanion.nvim/issues/1533)) ([7572e35](https://github.com/codybuell/codecompanion.nvim/commit/7572e35f22395ad2ab095e75b419a70a00ca2036))
* **adapters:** users can specify models for strategies ([#1518](https://github.com/codybuell/codecompanion.nvim/issues/1518)) ([763c81b](https://github.com/codybuell/codecompanion.nvim/commit/763c81b4823af3e3ef9cfb3f55f15f7f8f8b4b15))
* add chat ID to chat opened/hidden events ([17f7cbb](https://github.com/codybuell/codecompanion.nvim/commit/17f7cbb6cabdc12195f164acf4c59c7c7c205b64))
* add extensions api ([#1290](https://github.com/codybuell/codecompanion.nvim/issues/1290)) ([96bda85](https://github.com/codybuell/codecompanion.nvim/commit/96bda85c8bc77ac7a8f0b1a431c38e2c4103ad90))
* allow for full height chat windows when opening ([0e75d3b](https://github.com/codybuell/codecompanion.nvim/commit/0e75d3b9768e6a139bb2d51a1d05a6e2691171a8))
* allow for full height chat windows when opening ([5e00b43](https://github.com/codybuell/codecompanion.nvim/commit/5e00b432d9b340d4f189812945f6aab1edc00a51))
* **chat_buffer:** hide grouped tools in completion menu ([#1295](https://github.com/codybuell/codecompanion.nvim/issues/1295)) ([8380ee8](https://github.com/codybuell/codecompanion.nvim/commit/8380ee85fcd63a6752c545ed46fb9a2455f49527))
* **chat:** add `CodeCompanionChatDone` event ([#1881](https://github.com/codybuell/codecompanion.nvim/issues/1881)) ([e23e8e5](https://github.com/codybuell/codecompanion.nvim/commit/e23e8e5a5643b089607f21f576f6e63174cc44dc))
* **chat:** add `collapse_tools` setting for tool groups ([#1614](https://github.com/codybuell/codecompanion.nvim/issues/1614)) ([f1442c7](https://github.com/codybuell/codecompanion.nvim/commit/f1442c743f0f40132d07b42ccf99e450b648fcf6))
* **chat:** add copilot usage statistics with `gS` keymap ([#1677](https://github.com/codybuell/codecompanion.nvim/issues/1677)) ([8602a50](https://github.com/codybuell/codecompanion.nvim/commit/8602a50cacf111c69f35e305d1556afd9fa1f1a1))
* **chat:** add keymap to jump to file under cursor ([#1408](https://github.com/codybuell/codecompanion.nvim/issues/1408)) ([4c54348](https://github.com/codybuell/codecompanion.nvim/commit/4c5434883fff08bc9814fb71aff0f51518276acb))
* **chat:** add restore function to ensure a chat buffer can be made visible ([#1816](https://github.com/codybuell/codecompanion.nvim/issues/1816)) ([f37b8b9](https://github.com/codybuell/codecompanion.nvim/commit/f37b8b91d77745b5e5fc816272f50b9826ada6d9))
* **chat:** call slash commands with keymaps ([#1412](https://github.com/codybuell/codecompanion.nvim/issues/1412)) ([598af68](https://github.com/codybuell/codecompanion.nvim/commit/598af68b53394cfd43f7a098dcd463da86c5dc3f))
* **chat:** can preload with `default_tools` ([#1610](https://github.com/codybuell/codecompanion.nvim/issues/1610)) ([68c12a0](https://github.com/codybuell/codecompanion.nvim/commit/68c12a03a738aaeffe429c45b9f0c14ce00b0132))
* **chat:** can set default params for variables ([#1516](https://github.com/codybuell/codecompanion.nvim/issues/1516)) ([c0549d5](https://github.com/codybuell/codecompanion.nvim/commit/c0549d54203160020b4214d3e8827b2103a95b97))
* **chat:** chat buffer acts more like a normal buffer ([#1556](https://github.com/codybuell/codecompanion.nvim/issues/1556)) ([ebcdd78](https://github.com/codybuell/codecompanion.nvim/commit/ebcdd78a9d5d0d95c64fe9a106999b9f9603d2f3))
* **chat:** context can be folded in the chat buffer ([#1911](https://github.com/codybuell/codecompanion.nvim/issues/1911)) ([acfa69b](https://github.com/codybuell/codecompanion.nvim/commit/acfa69b6f712035dfc24c1aa2da3c8e5094e1699))
* **chat:** decorate your prompts ([080e8c9](https://github.com/codybuell/codecompanion.nvim/commit/080e8c9324ce40dd6b5e9aaf4ea27450707a55a7))
* **chat:** handle buffer deletion of chat buffers ([#1745](https://github.com/codybuell/codecompanion.nvim/issues/1745)) ([dbc7957](https://github.com/codybuell/codecompanion.nvim/commit/dbc7957ee92ddce403405c5c6d91ba7dccb278c7))
* **chat:** hide system prompts by default ([#1113](https://github.com/codybuell/codecompanion.nvim/issues/1113)) ([161aaba](https://github.com/codybuell/codecompanion.nvim/commit/161aaba38b06bf76f03a35c92ae809f819b88766))
* **chat:** remember cursor position when toggling ([#1523](https://github.com/codybuell/codecompanion.nvim/issues/1523)) ([51fb1df](https://github.com/codybuell/codecompanion.nvim/commit/51fb1dfa7227ace2e6635c8fcc75cc2ab1b607c6))
* **chat:** reuse existing tabs when jumping to a file. ([#1569](https://github.com/codybuell/codecompanion.nvim/issues/1569)) ([8747d88](https://github.com/codybuell/codecompanion.nvim/commit/8747d8871e310942996431d5374001a8b29ab0b7))
* **chat:** simplify watchers to use unified diffs ([#1583](https://github.com/codybuell/codecompanion.nvim/issues/1583)) ([81b817b](https://github.com/codybuell/codecompanion.nvim/commit/81b817b4186f85d4b2880516054b0e34bb27e60d))
* **chat:** support `:map-arguments` in keymaps ([#1572](https://github.com/codybuell/codecompanion.nvim/issues/1572)) ([d8e94cf](https://github.com/codybuell/codecompanion.nvim/commit/d8e94cfff7525ff5fdcc376093666c2cf57bb0e5))
* **chat:** tool output can be folded ([#1665](https://github.com/codybuell/codecompanion.nvim/issues/1665)) ([a87ebc7](https://github.com/codybuell/codecompanion.nvim/commit/a87ebc73ffc796bb5020cb083e2a5ef3c2c7e9bf))
* **diff:** improve default diff settings ([#1189](https://github.com/codybuell/codecompanion.nvim/issues/1189)) ([30da620](https://github.com/codybuell/codecompanion.nvim/commit/30da620ad79de0e6616b59e4f6d9c77f2d08f081))
* **events:** add context to event data payload ([03f55cb](https://github.com/codybuell/codecompanion.nvim/commit/03f55cb3dc0735ae9846bd420fa51ff36bb21fae))
* **events:** add context to InlineStarted event data payload ([#1293](https://github.com/codybuell/codecompanion.nvim/issues/1293)) ([03f55cb](https://github.com/codybuell/codecompanion.nvim/commit/03f55cb3dc0735ae9846bd420fa51ff36bb21fae))
* **gemini:** add gemini-2.5-flash ([#1347](https://github.com/codybuell/codecompanion.nvim/issues/1347)) ([b4d96cb](https://github.com/codybuell/codecompanion.nvim/commit/b4d96cbdca7ddc7870b0db0aded898ce9e6ea709))
* improve Telescope as action palette provider ([#1195](https://github.com/codybuell/codecompanion.nvim/issues/1195)) ([4fe008e](https://github.com/codybuell/codecompanion.nvim/commit/4fe008e43700bf45b5fbe8a22b0c32eee0d9dc75))
* **inline:** vars can now be callbacks closes [#1175](https://github.com/codybuell/codecompanion.nvim/issues/1175)  ([#1176](https://github.com/codybuell/codecompanion.nvim/issues/1176)) ([ccbaf20](https://github.com/codybuell/codecompanion.nvim/commit/ccbaf205d2d842dbef4c9ad9532576cf08fd4b1f))
* **openai:** update models ([#1346](https://github.com/codybuell/codecompanion.nvim/issues/1346)) ([b114cd1](https://github.com/codybuell/codecompanion.nvim/commit/b114cd1c24e784ef6ad0af9770bc141f5b81affd))
* **prompt_library:** custom prompts can add references ([#1384](https://github.com/codybuell/codecompanion.nvim/issues/1384)) ([3117350](https://github.com/codybuell/codecompanion.nvim/commit/31173502852f0d524e9e74e51255177f094c45e0))
* **prompts:** custom intro messages and no user prompt requirements ([#1927](https://github.com/codybuell/codecompanion.nvim/issues/1927)) ([17dc923](https://github.com/codybuell/codecompanion.nvim/commit/17dc923059ec1b793d9f881785571493adfca4de))
* **providers:** add coc.nvim ([#1421](https://github.com/codybuell/codecompanion.nvim/issues/1421)) ([c22d2a6](https://github.com/codybuell/codecompanion.nvim/commit/c22d2a675f76a97ede327a49baddec02ecd6f3f5))
* **slash_cmds:** auto select providers based on installed plugins ([#1216](https://github.com/codybuell/codecompanion.nvim/issues/1216)) ([78b260c](https://github.com/codybuell/codecompanion.nvim/commit/78b260c1df2d37f7c91790685e0db82b338760e2))
* **slash_command:** new `/quickfix` command ([#1600](https://github.com/codybuell/codecompanion.nvim/issues/1600)) ([6384dc0](https://github.com/codybuell/codecompanion.nvim/commit/6384dc0d5b150394403e5ab3bc89bfad301634ea))
* **slash_commands:** add Telescope provider for `/image` ([#1542](https://github.com/codybuell/codecompanion.nvim/issues/1542)) ([a12d3aa](https://github.com/codybuell/codecompanion.nvim/commit/a12d3aa9a0825ae72733fcffc646615bc3bee484))
* **slash_commands:** better caching and restoring of URLs ([#1491](https://github.com/codybuell/codecompanion.nvim/issues/1491)) ([d39890c](https://github.com/codybuell/codecompanion.nvim/commit/d39890cb432801cfe5b2a97104289e1cc4b9c415))
* **slash_commands:** for `/fetch` only show cache option if cached files exist ([#1582](https://github.com/codybuell/codecompanion.nvim/issues/1582)) ([f022807](https://github.com/codybuell/codecompanion.nvim/commit/f0228073aeb2b577425ace676c34654b2e1a308d))
* **symbols:** add Java support ([#1182](https://github.com/codybuell/codecompanion.nvim/issues/1182)) ([36ffd9c](https://github.com/codybuell/codecompanion.nvim/commit/36ffd9cd335afdc668e7bcc91ac6ae65149a4b2b))
* **tools:** `[@editor](https://github.com/editor)` tool merges with `[@insert](https://github.com/insert)_edit_into_file` ([#1586](https://github.com/codybuell/codecompanion.nvim/issues/1586)) ([bec6cd1](https://github.com/codybuell/codecompanion.nvim/commit/bec6cd124da650dc25472e03f4416cbe27574ef8))
* **tools:** `insert_edit_into_file` tool now saves the buffer ([#1813](https://github.com/codybuell/codecompanion.nvim/issues/1813)) ([f7c89b4](https://github.com/codybuell/codecompanion.nvim/commit/f7c89b4a17d040ba4288f60b08c138b8b94bde4a))
* **tools:** `web_search` tool can search specific sites ([#1741](https://github.com/codybuell/codecompanion.nvim/issues/1741)) ([6ef907f](https://github.com/codybuell/codecompanion.nvim/commit/6ef907fca6480dd11dc8f7a3048fec23f8a39b29))
* **tools:** add `[@next](https://github.com/next)_edit_suggestion` tool ([#1570](https://github.com/codybuell/codecompanion.nvim/issues/1570)) ([600e7b2](https://github.com/codybuell/codecompanion.nvim/commit/600e7b2d55816fa3b8103ef898aaaa31a224224f))
* **tools:** add `fetch_webpage` ([#1837](https://github.com/codybuell/codecompanion.nvim/issues/1837)) ([31fdc34](https://github.com/codybuell/codecompanion.nvim/commit/31fdc343e8aba7c3c1dcabbf13a1c7a6379d077b))
* **tools:** add `file_search` tool ([#1613](https://github.com/codybuell/codecompanion.nvim/issues/1613)) ([3582a2c](https://github.com/codybuell/codecompanion.nvim/commit/3582a2c465fe8900ad70e24877d48247abd608c9))
* **tools:** add `get_changed_files` tool ([#1777](https://github.com/codybuell/codecompanion.nvim/issues/1777)) ([ed5c493](https://github.com/codybuell/codecompanion.nvim/commit/ed5c493eaf54b10b56f1489fdeac3689cd583807))
* **tools:** add `grep_search` tool ([#1651](https://github.com/codybuell/codecompanion.nvim/issues/1651)) ([98eb86c](https://github.com/codybuell/codecompanion.nvim/commit/98eb86cd5e66aa0f2bc3c47eb699ea81c99b74db))
* **tools:** add `list_code_usages` tool ([#1696](https://github.com/codybuell/codecompanion.nvim/issues/1696)) ([16b51b0](https://github.com/codybuell/codecompanion.nvim/commit/16b51b016d3bb1200e8c9350c5ced97f481916fe))
* **tools:** add tavily adapter and `[@web](https://github.com/web)_search` tool ([#1279](https://github.com/codybuell/codecompanion.nvim/issues/1279)) ([a5a8701](https://github.com/codybuell/codecompanion.nvim/commit/a5a8701bf8814ff0ba9bf5f76b3a3deedf3e5f28))
* **tools:** auto_tool_mode now auto submits ([#1580](https://github.com/codybuell/codecompanion.nvim/issues/1580)) ([1b2ab64](https://github.com/codybuell/codecompanion.nvim/commit/1b2ab6445dac16908b2136bd7c071e4dcb7f38d6))
* **tools:** callbacks can be functions ([#1065](https://github.com/codybuell/codecompanion.nvim/issues/1065)) ([dff8a1c](https://github.com/codybuell/codecompanion.nvim/commit/dff8a1c969b66987923c14a305a654ea51b5e2a6))
* **tools:** can be conditionally loaded ([#1647](https://github.com/codybuell/codecompanion.nvim/issues/1647)) ([40ba4fc](https://github.com/codybuell/codecompanion.nvim/commit/40ba4fc7e7749a089f23123593d9a6c85140fcfc))
* **tools:** can load tools via relative paths ([#1552](https://github.com/codybuell/codecompanion.nvim/issues/1552)) ([7991e53](https://github.com/codybuell/codecompanion.nvim/commit/7991e53c0270db489b94e1a26c0d1608aa2d6206))
* **tools:** function tools can update the agent status + doc updates ([#1074](https://github.com/codybuell/codecompanion.nvim/issues/1074)) ([e59c1f0](https://github.com/codybuell/codecompanion.nvim/commit/e59c1f04983edac15f195bfc73cd90bf08a3565b))
* **tools:** function-based tools can be async ([#1107](https://github.com/codybuell/codecompanion.nvim/issues/1107)) ([97636b9](https://github.com/codybuell/codecompanion.nvim/commit/97636b902ac20c665b0b3d9d5b2c62c16676e136))
* **tools:** improve auto-submit and turn on by default ([#1539](https://github.com/codybuell/codecompanion.nvim/issues/1539)) ([3388e15](https://github.com/codybuell/codecompanion.nvim/commit/3388e1562aaa6d6deab90e8ad141439ed2bcac2f))
* **tools:** move to function calling ([#1141](https://github.com/codybuell/codecompanion.nvim/issues/1141)) ([4fdf370](https://github.com/codybuell/codecompanion.nvim/commit/4fdf3707f6d8492b34629580935220c13dcac490))
* **tools:** system_prompt in tool groups can be a function ([#1210](https://github.com/codybuell/codecompanion.nvim/issues/1210)) ([825f5ea](https://github.com/codybuell/codecompanion.nvim/commit/825f5eabc2e62f8a3d100f5246cd02a301681295))
* **ui:** allow toggling the visibility of individual references. ([#1245](https://github.com/codybuell/codecompanion.nvim/issues/1245)) ([cc25e49](https://github.com/codybuell/codecompanion.nvim/commit/cc25e49e33de63064026a7ad0295e517a8f11391))
* **ui:** chat buffer can be sticky when navigating tabs ([#1842](https://github.com/codybuell/codecompanion.nvim/issues/1842)) ([71fb6a8](https://github.com/codybuell/codecompanion.nvim/commit/71fb6a80894c584d23ea55d4e8d3448cbb04eeaf))
* **workspaces:** files can be opened as buffers ([#1708](https://github.com/codybuell/codecompanion.nvim/issues/1708)) ([2ea49ff](https://github.com/codybuell/codecompanion.nvim/commit/2ea49ff2063100757e71b0e327b7a32a1d566a9d))
* **workspaces:** new workspace file format ([#1089](https://github.com/codybuell/codecompanion.nvim/issues/1089)) ([3f7fd62](https://github.com/codybuell/codecompanion.nvim/commit/3f7fd6292b9d43d38e9760f43b581652210b0349))


### Bug Fixes

* **adapter:** copilot unauthorized token expired ([#1789](https://github.com/codybuell/codecompanion.nvim/issues/1789)) ([d455d71](https://github.com/codybuell/codecompanion.nvim/commit/d455d71f5887063b08da3fc3cd60548460f1c875))
* **adapters:** add mistral to the config ([#1133](https://github.com/codybuell/codecompanion.nvim/issues/1133)) ([fbb0e1d](https://github.com/codybuell/codecompanion.nvim/commit/fbb0e1d0ccdd2eaa16ea9ba0f94ca8e4c64f5b97))
* **adapters:** anthropic inline editing ([#1142](https://github.com/codybuell/codecompanion.nvim/issues/1142)) ([ad99cda](https://github.com/codybuell/codecompanion.nvim/commit/ad99cdaca4df56bb3db5ac0a17b423740ce0396d))
* **adapters:** copilot token issue when changing adapter closes [#1149](https://github.com/codybuell/codecompanion.nvim/issues/1149) ([#1155](https://github.com/codybuell/codecompanion.nvim/issues/1155)) ([0cc0541](https://github.com/codybuell/codecompanion.nvim/commit/0cc054199c20416da45bdbcadd10b3a9ea748557))
* **adapters:** enable OpenAI vision support ([#1486](https://github.com/codybuell/codecompanion.nvim/issues/1486)) ([f8e14ae](https://github.com/codybuell/codecompanion.nvim/commit/f8e14ae0be51c0f65b0284f787277407db30ace7))
* **adapters:** ensure cache_expires is set ([#1146](https://github.com/codybuell/codecompanion.nvim/issues/1146)) ([5d6e3c5](https://github.com/codybuell/codecompanion.nvim/commit/5d6e3c5ad3436e1d0baca6588e96426e11f105e2))
* **adapters:** fix streaming for gemini adapter ([#1561](https://github.com/codybuell/codecompanion.nvim/issues/1561)) ([585fade](https://github.com/codybuell/codecompanion.nvim/commit/585fadef1940a66216124bdbd1bace55be3b1e73))
* **adapters:** handle choices as function in reasoning for OpenAI ([#1902](https://github.com/codybuell/codecompanion.nvim/issues/1902)) ([ea99a1b](https://github.com/codybuell/codecompanion.nvim/commit/ea99a1b4b341286df9d39dfe101c649bf868d39b))
* **adapters:** improve resolving adapters ([#1367](https://github.com/codybuell/codecompanion.nvim/issues/1367)) ([2c296ba](https://github.com/codybuell/codecompanion.nvim/commit/2c296ba17c4bc581eee11fc90683e5b130f65d89))
* **adapters:** missing models in copilot ([#1899](https://github.com/codybuell/codecompanion.nvim/issues/1899)) ([30f7cc7](https://github.com/codybuell/codecompanion.nvim/commit/30f7cc7b768f4f0e694c1841e316d0cda91d7323))
* **adapters:** model choice in azure openai closes [#1273](https://github.com/codybuell/codecompanion.nvim/issues/1273) ([#1274](https://github.com/codybuell/codecompanion.nvim/issues/1274)) ([4dd516a](https://github.com/codybuell/codecompanion.nvim/commit/4dd516ae6880b612073849f78ece5f67c854c44d))
* **adapters:** ollama model selection when changing adapter ([#1890](https://github.com/codybuell/codecompanion.nvim/issues/1890)) ([2695b92](https://github.com/codybuell/codecompanion.nvim/commit/2695b9221ba45071d7aefee49ad20880278e2344))
* **adapters:** reasoning output and tool calls in anthropic ([#1807](https://github.com/codybuell/codecompanion.nvim/issues/1807)) ([5717527](https://github.com/codybuell/codecompanion.nvim/commit/5717527ba6b1086ed748dd3b1390d0f431ec46cb)), closes [#1752](https://github.com/codybuell/codecompanion.nvim/issues/1752)
* **adapters:** reduce copilot premium request consumption ([#1738](https://github.com/codybuell/codecompanion.nvim/issues/1738)) ([ed96fe3](https://github.com/codybuell/codecompanion.nvim/commit/ed96fe33c17b41957f2334b1cae29c24d35f8ef2))
* **adapters:** remove `tfs_z` from Ollama schema ([#1152](https://github.com/codybuell/codecompanion.nvim/issues/1152)) ([52e2969](https://github.com/codybuell/codecompanion.nvim/commit/52e296963a0a8e6414c0ec72f6bc687b16f2eca7))
* **adapters:** resolve adapters with correct name ([#1459](https://github.com/codybuell/codecompanion.nvim/issues/1459)) ([0beb918](https://github.com/codybuell/codecompanion.nvim/commit/0beb9183954ae1afa2e1f5a91812706764d1a743))
* **adapters:** resolve not using custom adapter ([#1461](https://github.com/codybuell/codecompanion.nvim/issues/1461)) ([b79b33a](https://github.com/codybuell/codecompanion.nvim/commit/b79b33a58304cd386f72ee0ab159824fa21321c6))
* **adapters:** resolving adapters from prompt library ([#1536](https://github.com/codybuell/codecompanion.nvim/issues/1536)) ([9964f48](https://github.com/codybuell/codecompanion.nvim/commit/9964f4880c66376e4c9f0d45f5fd2ab1e5496254)), closes [#1521](https://github.com/codybuell/codecompanion.nvim/issues/1521)
* **adapters:** stack overflow if default model is function ([#1417](https://github.com/codybuell/codecompanion.nvim/issues/1417)) ([2d28420](https://github.com/codybuell/codecompanion.nvim/commit/2d284203ec63136f72e75a61b1cb19abb31a1ebe)), closes [#1415](https://github.com/codybuell/codecompanion.nvim/issues/1415)
* **adapters:** update HuggingFace endpoint ([#1868](https://github.com/codybuell/codecompanion.nvim/issues/1868)) ([d067c84](https://github.com/codybuell/codecompanion.nvim/commit/d067c846d4f7239c6d3524ea3535f459b18dfd99)), closes [#1864](https://github.com/codybuell/codecompanion.nvim/issues/1864)
* **anthropic:** inline editing closes [#1127](https://github.com/codybuell/codecompanion.nvim/issues/1127) ([#1130](https://github.com/codybuell/codecompanion.nvim/issues/1130)) ([bc89f11](https://github.com/codybuell/codecompanion.nvim/commit/bc89f118f1991e9be24c784f72f57f373aa6f84b))
* **blink:** add support to blink newer than 0.13.1 ([#1139](https://github.com/codybuell/codecompanion.nvim/issues/1139)) ([3ee07d6](https://github.com/codybuell/codecompanion.nvim/commit/3ee07d6805d85ddd9c97715af5bc79c8e7f2adb1))
* **blink:** cursor put at wrong position after accepting ([#1179](https://github.com/codybuell/codecompanion.nvim/issues/1179)) ([f83641b](https://github.com/codybuell/codecompanion.nvim/commit/f83641ba9e3a8993afb03a856701623c746a05b8))
* **chat:** `:CodeCompanionChat` now works ([#1219](https://github.com/codybuell/codecompanion.nvim/issues/1219)) ([593f2c5](https://github.com/codybuell/codecompanion.nvim/commit/593f2c5e4ead3247e5daca37bf673d0a6fcb1759))
* **chat:** can set system prompt dynamically when switching adapters closes [#1033](https://github.com/codybuell/codecompanion.nvim/issues/1033) ([#1077](https://github.com/codybuell/codecompanion.nvim/issues/1077)) ([b76a47a](https://github.com/codybuell/codecompanion.nvim/commit/b76a47a62383dcf22dd41839467ea37d2e82ee59))
* **chat:** codeblock formatting in chat buffer ([#1916](https://github.com/codybuell/codecompanion.nvim/issues/1916)) ([3d4d85f](https://github.com/codybuell/codecompanion.nvim/commit/3d4d85f03acc3a31ea2ec9bd34db5194ed7696ff))
* **chat:** correct yank command syntax in keymaps ([#1568](https://github.com/codybuell/codecompanion.nvim/issues/1568)) ([05555a4](https://github.com/codybuell/codecompanion.nvim/commit/05555a40f263488592556c3acfb61ef323805136))
* **chat:** don't cache blink completions ([#1618](https://github.com/codybuell/codecompanion.nvim/issues/1618)) ([8a958a4](https://github.com/codybuell/codecompanion.nvim/commit/8a958a4a1a11e58f1eb30d378c4c88c611d388d4))
* **chat:** don't remove custom system prompts when using `gs` ([#1770](https://github.com/codybuell/codecompanion.nvim/issues/1770)) ([4e75c62](https://github.com/codybuell/codecompanion.nvim/commit/4e75c629d1c1658c9330a75fd2ffec9cad59ed50)), closes [#1749](https://github.com/codybuell/codecompanion.nvim/issues/1749)
* **chat:** header line when used with prompt library closes [#1319](https://github.com/codybuell/codecompanion.nvim/issues/1319) ([#1327](https://github.com/codybuell/codecompanion.nvim/issues/1327)) ([77ff03d](https://github.com/codybuell/codecompanion.nvim/commit/77ff03d4ce89ca3b4ec06033df4106d11eb536ad))
* **chat:** paths are always relative and wrap context in &lt;attachment&gt; ([#1633](https://github.com/codybuell/codecompanion.nvim/issues/1633)) ([2185ccc](https://github.com/codybuell/codecompanion.nvim/commit/2185ccc81eeb9080f6c856a408ed3cba3f2bb7ef)), closes [#1630](https://github.com/codybuell/codecompanion.nvim/issues/1630) [#1631](https://github.com/codybuell/codecompanion.nvim/issues/1631)
* **chat:** prevent double references in the chat buffer ([#1348](https://github.com/codybuell/codecompanion.nvim/issues/1348)) ([aafbb62](https://github.com/codybuell/codecompanion.nvim/commit/aafbb62c5ceb3f019610fb0e9ed3c04305b59a23))
* **chat:** references not being added with `show_header_separators` closes [#1067](https://github.com/codybuell/codecompanion.nvim/issues/1067) ([#1069](https://github.com/codybuell/codecompanion.nvim/issues/1069)) ([9cd4094](https://github.com/codybuell/codecompanion.nvim/commit/9cd4094e5ccc428faae487568aabeb4873393f1b))
* **chat:** Register cmp completions when filetype is set ([#1560](https://github.com/codybuell/codecompanion.nvim/issues/1560)) ([3d62ac3](https://github.com/codybuell/codecompanion.nvim/commit/3d62ac3ebe840245b157e169d06b8d87ee878dc5))
* **chat:** start_in_insert_mode with telescope ([#1815](https://github.com/codybuell/codecompanion.nvim/issues/1815)) ([dc5eca1](https://github.com/codybuell/codecompanion.nvim/commit/dc5eca177248f5d77e7d01fdd98e18f90ecfcc56))
* **chat:** toggling when chat buffer is not in the current tab ([#1725](https://github.com/codybuell/codecompanion.nvim/issues/1725)) ([4f91b4b](https://github.com/codybuell/codecompanion.nvim/commit/4f91b4b6b400b97b923537cb75721b8452cd54dc))
* **chat:** tool folding ([#1811](https://github.com/codybuell/codecompanion.nvim/issues/1811)) ([b506225](https://github.com/codybuell/codecompanion.nvim/commit/b5062255224cb72ee35e374ac764ac53f6fe9fa1))
* **chat:** tools can now be dynamically added ([#1693](https://github.com/codybuell/codecompanion.nvim/issues/1693)) ([3a5f895](https://github.com/codybuell/codecompanion.nvim/commit/3a5f8958197b2e134e7d299673bff76c785dbc99))
* **chat:** tools should be empty table if not used ([#1373](https://github.com/codybuell/codecompanion.nvim/issues/1373)) ([3f72bac](https://github.com/codybuell/codecompanion.nvim/commit/3f72bacfd74fc4e4b4ea07257e61ec6fb3fb004f)), closes [#1371](https://github.com/codybuell/codecompanion.nvim/issues/1371)
* **chat:** unwatch buffers when they're unlisted ([#1809](https://github.com/codybuell/codecompanion.nvim/issues/1809)) ([ea29e11](https://github.com/codybuell/codecompanion.nvim/commit/ea29e112916bad53e52f514bff1bc2e54e2287c2))
* **chat:** update system prompt to avoid using h1 and h2 headers ([#1084](https://github.com/codybuell/codecompanion.nvim/issues/1084)) ([8f53a3a](https://github.com/codybuell/codecompanion.nvim/commit/8f53a3ab541545fdf325bb0dc3bec1de7207aab6))
* **chat:** various chat buffer fixes ([#1336](https://github.com/codybuell/codecompanion.nvim/issues/1336)) ([1e2f69a](https://github.com/codybuell/codecompanion.nvim/commit/1e2f69a9a65bd716cf897393e7af65fc74907ed8))
* **chat:** watchers use the same diff format as in patch ([#1655](https://github.com/codybuell/codecompanion.nvim/issues/1655)) ([86b1ff1](https://github.com/codybuell/codecompanion.nvim/commit/86b1ff13d140d3b63f49f1cbfd69873b2cbbe40d))
* **chat:** word boundary matching for tools and variables ([#1503](https://github.com/codybuell/codecompanion.nvim/issues/1503)) ([f572601](https://github.com/codybuell/codecompanion.nvim/commit/f57260190a40bb4f071d27c5386eeff1440c111b))
* **completion:** disable default execute implementation for blink.cmp ([#1137](https://github.com/codybuell/codecompanion.nvim/issues/1137)) ([b88684d](https://github.com/codybuell/codecompanion.nvim/commit/b88684d97af444947cedaeda9cc7ba0205b0d3b4))
* **deepseek:** inline prompt to chat causes error ([#1406](https://github.com/codybuell/codecompanion.nvim/issues/1406)) ([c912e2d](https://github.com/codybuell/codecompanion.nvim/commit/c912e2d72a91629f554142af3e9a648e54112ca4)), closes [#1405](https://github.com/codybuell/codecompanion.nvim/issues/1405)
* **deepseek:** reasoning output closes [#1091](https://github.com/codybuell/codecompanion.nvim/issues/1091) ([#1095](https://github.com/codybuell/codecompanion.nvim/issues/1095)) ([bcdfa2b](https://github.com/codybuell/codecompanion.nvim/commit/bcdfa2b15232058964c53856cfbf736988ba0066))
* **inline:** "new" placement doesn't create diffview ([#1343](https://github.com/codybuell/codecompanion.nvim/issues/1343)) ([9ab6ac1](https://github.com/codybuell/codecompanion.nvim/commit/9ab6ac1126d89f74b9882e4343eb1397e4b052da))
* **inline:** chat placements with claude-sonnet-4 ([#1636](https://github.com/codybuell/codecompanion.nvim/issues/1636)) ([0f82355](https://github.com/codybuell/codecompanion.nvim/commit/0f8235523ee555daa6acc6a5e5b5c4472ed60b43)), closes [#1626](https://github.com/codybuell/codecompanion.nvim/issues/1626)
* **inline:** don't modify prompts going to the chat buffer ([#1447](https://github.com/codybuell/codecompanion.nvim/issues/1447)) ([a3b2b63](https://github.com/codybuell/codecompanion.nvim/commit/a3b2b633c6e17f0a891713c724285843c9706e1e))
* **inline:** events are fired with the correct names ([#1919](https://github.com/codybuell/codecompanion.nvim/issues/1919)) ([18cf425](https://github.com/codybuell/codecompanion.nvim/commit/18cf425c837d6e3745b4872d5bf48a2be18b414e))
* **inline:** keymap modes ([#1468](https://github.com/codybuell/codecompanion.nvim/issues/1468)) ([7ac8234](https://github.com/codybuell/codecompanion.nvim/commit/7ac823450c490201af3362a0861c2c1c19b827a8))
* **inline:** prompting using telescope and dressing in the UI ([#1702](https://github.com/codybuell/codecompanion.nvim/issues/1702)) ([50dde48](https://github.com/codybuell/codecompanion.nvim/commit/50dde48a6a078283c30ec177f7ab3c4eaa350341))
* **inline:** remove blank lines in diffs ([#1565](https://github.com/codybuell/codecompanion.nvim/issues/1565)) ([fee2dd1](https://github.com/codybuell/codecompanion.nvim/commit/fee2dd137b515b779c57c915ca031921e6591d85))
* **inline:** revert keymap changes ([#1622](https://github.com/codybuell/codecompanion.nvim/issues/1622)) ([6f89961](https://github.com/codybuell/codecompanion.nvim/commit/6f89961632defce5a591195851569758a1e15a0e)), closes [#1621](https://github.com/codybuell/codecompanion.nvim/issues/1621)
* **openai:** do not send empty tools array ([#1381](https://github.com/codybuell/codecompanion.nvim/issues/1381)) ([33364a0](https://github.com/codybuell/codecompanion.nvim/commit/33364a070f06e3d8cf5276ac409c58de4f922716))
* **prompt_library:** completion in the cmd line ([#1893](https://github.com/codybuell/codecompanion.nvim/issues/1893)) ([e8ab7ef](https://github.com/codybuell/codecompanion.nvim/commit/e8ab7eff9fb61dc7177a1d9bb830886eacbe3114))
* **prompt_library:** custom prompts containing URLs ([#1849](https://github.com/codybuell/codecompanion.nvim/issues/1849)) ([164e95c](https://github.com/codybuell/codecompanion.nvim/commit/164e95c6ff0becd6d152e06be56ccd98f53bc5a8))
* **prompt_library:** don't trim empty lines with user role content ([#1211](https://github.com/codybuell/codecompanion.nvim/issues/1211)) ([5a18f89](https://github.com/codybuell/codecompanion.nvim/commit/5a18f8910dbae5b153045f7be2051a042a11e764))
* **prompts:** agentic workflow in the config ([#1764](https://github.com/codybuell/codecompanion.nvim/issues/1764)) ([0b3831d](https://github.com/codybuell/codecompanion.nvim/commit/0b3831ddee88a389aa663fb05e35f2724f6df7da))
* **prompts:** do not ignore user prompt ([#1110](https://github.com/codybuell/codecompanion.nvim/issues/1110)) ([5ee7873](https://github.com/codybuell/codecompanion.nvim/commit/5ee7873342e254828963930e5c9e922c8d978211))
* **prompts:** reword vectorcode tool in workspace prompt ([#1775](https://github.com/codybuell/codecompanion.nvim/issues/1775)) ([3527a9c](https://github.com/codybuell/codecompanion.nvim/commit/3527a9c85b58a8db2fee6d7dcde72077ba790a4a))
* **providers:** only use `mini.diff` if initialized ([#1472](https://github.com/codybuell/codecompanion.nvim/issues/1472)) ([f7bb598](https://github.com/codybuell/codecompanion.nvim/commit/f7bb59888b201507a43c856460d455f786c989f8))
* **providers:** register coc execute function ([#1548](https://github.com/codybuell/codecompanion.nvim/issues/1548)) ([92ba84c](https://github.com/codybuell/codecompanion.nvim/commit/92ba84cddf19d936809d9775884699e66a070ec4))
* **providers:** use mini.diff by default if available ([#1368](https://github.com/codybuell/codecompanion.nvim/issues/1368)) ([127a2c1](https://github.com/codybuell/codecompanion.nvim/commit/127a2c1614df2e8565a98e83e3567980c32d9876))
* **references:** don't remove tools by checking chat refs while auto_submitting ([#1320](https://github.com/codybuell/codecompanion.nvim/issues/1320)) ([b2a0aa2](https://github.com/codybuell/codecompanion.nvim/commit/b2a0aa2aa71e0f401099ed88f35cc94e0163aeea))
* **references:** unlock buffer when adding reference after a tool output ([#1477](https://github.com/codybuell/codecompanion.nvim/issues/1477)) ([df44594](https://github.com/codybuell/codecompanion.nvim/commit/df4459401180612bc5b7b167eff7133324e85f1c))
* **refs:** can handle blank messages closes [#1311](https://github.com/codybuell/codecompanion.nvim/issues/1311) ([#1314](https://github.com/codybuell/codecompanion.nvim/issues/1314)) ([c3d2326](https://github.com/codybuell/codecompanion.nvim/commit/c3d2326ec1f1ef9f1a6867d478f3be4930fcdf7d))
* **refs:** do not parse non-existent message ([#1332](https://github.com/codybuell/codecompanion.nvim/issues/1332)) ([c7aeeab](https://github.com/codybuell/codecompanion.nvim/commit/c7aeeaba79c48234f3be61d04f77fe88cf2a7025))
* require tool module path correctly ([#1670](https://github.com/codybuell/codecompanion.nvim/issues/1670)) ([dbefc41](https://github.com/codybuell/codecompanion.nvim/commit/dbefc41dba2f46720ecb6ecec34c0c5f80022f2b))
* **slash_commands:** update adapter reference ([#1502](https://github.com/codybuell/codecompanion.nvim/issues/1502)) ([41108b2](https://github.com/codybuell/codecompanion.nvim/commit/41108b2ee7d71eca50ff6c5008b30a853e14cf35))
* **snacks:** focus on chat window after closing picker ([#1248](https://github.com/codybuell/codecompanion.nvim/issues/1248)) ([bd6bd19](https://github.com/codybuell/codecompanion.nvim/commit/bd6bd199bc019037613cb64bcdb70e6b8952c038))
* **snacks:** focus on floating chat windows after closing picker ([#1359](https://github.com/codybuell/codecompanion.nvim/issues/1359)) ([6090826](https://github.com/codybuell/codecompanion.nvim/commit/60908265b78145c7c8595d81b36792bc01cd56e5))
* **tool:** output handler can be any type ([#1106](https://github.com/codybuell/codecompanion.nvim/issues/1106)) ([8823590](https://github.com/codybuell/codecompanion.nvim/commit/8823590f3cb251eb09315682bb3f40abf212969b))
* **tools:** [@files](https://github.com/files) tool reject causes error ([#1082](https://github.com/codybuell/codecompanion.nvim/issues/1082)) ([e9e7b26](https://github.com/codybuell/codecompanion.nvim/commit/e9e7b26187e3574a41aa09330e6dd4bb28c1fa9e))
* **tools:** `insert_edit_info_file` tool can insert at EOF ([#1650](https://github.com/codybuell/codecompanion.nvim/issues/1650)) ([d54a41a](https://github.com/codybuell/codecompanion.nvim/commit/d54a41a86a510e9c728f6e460801afdf581d69da))
* **tools:** `read_files` tool can read entire file if `end_line` is greater than total lines ([#1824](https://github.com/codybuell/codecompanion.nvim/issues/1824)) ([562950d](https://github.com/codybuell/codecompanion.nvim/commit/562950d1584a1ff603921ec7ce48638e2d7f9e1d))
* **tools:** auto submit sends updated buffer ([#1545](https://github.com/codybuell/codecompanion.nvim/issues/1545)) ([82f5917](https://github.com/codybuell/codecompanion.nvim/commit/82f5917455cb7156f36daa99b2ec8049a7958ce5))
* **tools:** auto_submitting processes requests in order ([#1325](https://github.com/codybuell/codecompanion.nvim/issues/1325)) ([0d910ae](https://github.com/codybuell/codecompanion.nvim/commit/0d910ae6ddb4af6e5e2c34838760da241999cd3f))
* **tools:** be more explicit about the xml schema ([95bb7a5](https://github.com/codybuell/codecompanion.nvim/commit/95bb7a579b1e9455c855f59bd4b6bb2ca860aee3))
* **tools:** be more explicit about the xml schema in files tool ([#1232](https://github.com/codybuell/codecompanion.nvim/issues/1232)) ([95bb7a5](https://github.com/codybuell/codecompanion.nvim/commit/95bb7a579b1e9455c855f59bd4b6bb2ca860aee3))
* **tools:** call subscribers after an LLM response ([#1365](https://github.com/codybuell/codecompanion.nvim/issues/1365)) ([8dc896a](https://github.com/codybuell/codecompanion.nvim/commit/8dc896af23c1e086aee13fe7c850eab365ad337e))
* **tools:** error when trying to log nil tool ([#1896](https://github.com/codybuell/codecompanion.nvim/issues/1896)) ([63ce32a](https://github.com/codybuell/codecompanion.nvim/commit/63ce32aa44135ba863aa1e5ed49a0abfdaeb926e))
* **tools:** failed/cancelled/rejected tool calls no longer block the execution queue ([#1852](https://github.com/codybuell/codecompanion.nvim/issues/1852)) ([48d7e8f](https://github.com/codybuell/codecompanion.nvim/commit/48d7e8f6b2fb894afd68e1475bf63d81c934239a)), closes [#1850](https://github.com/codybuell/codecompanion.nvim/issues/1850)
* **tools:** file tool now outputs content to the LLM ([#1321](https://github.com/codybuell/codecompanion.nvim/issues/1321)) ([50ce548](https://github.com/codybuell/codecompanion.nvim/commit/50ce548b099318d6c14c56949d4a3f3a4693b7b1))
* **tools:** files tool can now edit files ([#1317](https://github.com/codybuell/codecompanion.nvim/issues/1317)) ([668fecc](https://github.com/codybuell/codecompanion.nvim/commit/668fecc61777e62a65d624cc88f2a8468ac4cd39))
* **tools:** make `insert_edit_into_file` more robust for patch markers ([#1653](https://github.com/codybuell/codecompanion.nvim/issues/1653)) ([a6e226c](https://github.com/codybuell/codecompanion.nvim/commit/a6e226ced63d9bb5e601213e63f5cd07ad09f7cd))
* **tools:** multiple bug fixes ([07f7518](https://github.com/codybuell/codecompanion.nvim/commit/07f75181d716a07d683ca66afb8f4dc6b6acbdd3))
* **tools:** patching algorithm can start with an empty line ([#1663](https://github.com/codybuell/codecompanion.nvim/issues/1663)) ([370ec56](https://github.com/codybuell/codecompanion.nvim/commit/370ec56f388fd317fd324d68709e9441d3461896))
* **tools:** patching algorithm now supports lines starting with `-` ([#1654](https://github.com/codybuell/codecompanion.nvim/issues/1654)) ([9011839](https://github.com/codybuell/codecompanion.nvim/commit/9011839a6827b264d632822d9ce17cb66fe95e61))
* **tools:** patching for empty and small files with insufficient context ([#1734](https://github.com/codybuell/codecompanion.nvim/issues/1734)) ([cb55ef0](https://github.com/codybuell/codecompanion.nvim/commit/cb55ef006be3e75015c84fbd9adef14b3546a08f))
* **tools:** tool groups are replaced properly in the chat buffer ([#1364](https://github.com/codybuell/codecompanion.nvim/issues/1364)) ([9402ae3](https://github.com/codybuell/codecompanion.nvim/commit/9402ae373f23269f1baef8ccc32578c128cbf2ed))
* **tools:** tools can now be deleted as references ([#1357](https://github.com/codybuell/codecompanion.nvim/issues/1357)) ([7d0938c](https://github.com/codybuell/codecompanion.nvim/commit/7d0938c1dc117c9c63569a388b9d091ee884d2ce))
* **ui:** add blank line before user role ([#1225](https://github.com/codybuell/codecompanion.nvim/issues/1225)) ([ddda7e8](https://github.com/codybuell/codecompanion.nvim/commit/ddda7e8208856df8c7d32c7fcf6276962ebbb437))
* **ui:** enable keymaps in debug chat float for easier quitting ([#1923](https://github.com/codybuell/codecompanion.nvim/issues/1923)) ([5e7d451](https://github.com/codybuell/codecompanion.nvim/commit/5e7d451098f61afdb13710844aaf0d83530e4128))
* **ui:** handle custom winborder characters ([#1915](https://github.com/codybuell/codecompanion.nvim/issues/1915)) ([9e23ef1](https://github.com/codybuell/codecompanion.nvim/commit/9e23ef19429e17d68c0bda28c687b85b6741e666))
* **ui:** include `kind` option in all `vim.ui.select` calls ([#1456](https://github.com/codybuell/codecompanion.nvim/issues/1456)) ([9d8fc51](https://github.com/codybuell/codecompanion.nvim/commit/9d8fc51a1923333de683ebf85c633fd003ad2b9b))
* **ui:** reduce delay in using `gr` to reject diff ([#1917](https://github.com/codybuell/codecompanion.nvim/issues/1917)) ([55c29d9](https://github.com/codybuell/codecompanion.nvim/commit/55c29d920380c5a83ca00902dd5d3c3dd22a9211))
* **ui:** respect opts.visible for non-"system" roles ([#1204](https://github.com/codybuell/codecompanion.nvim/issues/1204)) ([ef9cdc6](https://github.com/codybuell/codecompanion.nvim/commit/ef9cdc6f7a04d99b74988af70d0e724ec32cf236))
* **utils:** fallback to vim.highlight ([#1611](https://github.com/codybuell/codecompanion.nvim/issues/1611)) ([6d62e18](https://github.com/codybuell/codecompanion.nvim/commit/6d62e1843cbee7a181a5b86de9e4ec554650d8d9))
* **variables:** ensure special chars are matched ([#1470](https://github.com/codybuell/codecompanion.nvim/issues/1470)) ([a682004](https://github.com/codybuell/codecompanion.nvim/commit/a682004d4ff97c0450617975699bfc78029862be))
* **workflows:** ensure references are rendered ([#1376](https://github.com/codybuell/codecompanion.nvim/issues/1376)) ([598a444](https://github.com/codybuell/codecompanion.nvim/commit/598a4443e2906a382bc182e5558371ea2dd3df64))
* **workflows:** successive prompts and tools now work ([#1508](https://github.com/codybuell/codecompanion.nvim/issues/1508)) ([0112caf](https://github.com/codybuell/codecompanion.nvim/commit/0112caf54a79bb6cfbcb6e67cd16a3a9f18af9a7)), closes [#1496](https://github.com/codybuell/codecompanion.nvim/issues/1496)
* **workspace:** add description to buffer content ([#1713](https://github.com/codybuell/codecompanion.nvim/issues/1713)) ([ff939d1](https://github.com/codybuell/codecompanion.nvim/commit/ff939d18d8d64b0bef985aeb9be26f57e4ee8837))


### Code Refactoring

* **chat:** move `opts.goto_file_action` to `strategies.chat.opts` ([#1571](https://github.com/codybuell/codecompanion.nvim/issues/1571)) ([cdf7721](https://github.com/codybuell/codecompanion.nvim/commit/cdf772165782e55a451c0793bf4c2a89926b89bd))
* **chat:** move the `goto_file_action` to `strategies.chat.opts` ([cdf7721](https://github.com/codybuell/codecompanion.nvim/commit/cdf772165782e55a451c0793bf4c2a89926b89bd))
* **chat:** tools and variables now use `@{tool}` and `#{variable}` syntax ([#1740](https://github.com/codybuell/codecompanion.nvim/issues/1740)) ([f89eca2](https://github.com/codybuell/codecompanion.nvim/commit/f89eca26368b29bc8259921d459c1b4e5bfaeebb))
* remove support for nvim-0.10 ([#1639](https://github.com/codybuell/codecompanion.nvim/issues/1639)) ([5d0ef43](https://github.com/codybuell/codecompanion.nvim/commit/5d0ef43ed822ea3341ed0989e45f2d10d57ba359))
